...
const sessionAnswerKey = 'SESSION_ANSWER'; //string
const sessionUserAttemptsKey = 'SESSION_USER_ATTEMPTS'; //number
const sessionUserIsPlayingKey = 'SESSION_USER_IS_PLAYING'; //boolean

//inisialisasi key untuk local storage
const localTotalVictoryKey = 'LOCAL_TOTAL_VICTORIES_PLAYED'; //number
const localMaximumAttemptsKey = 'LOCAL_MAXIMUM_ATTEMPTS'; //number

//setelah inisialisasi variabel, buat item storage
...
//Me-reset elemen pada session tersebut ketika webpage di-refresh
